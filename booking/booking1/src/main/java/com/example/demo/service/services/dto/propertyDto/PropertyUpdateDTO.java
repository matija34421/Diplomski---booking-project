...
public class PropertyUpdateDTO {
	...
	public PropertyUpdateDTO(int id, String title, String description, String type, String location,String addres, double price,
			String picture_path, int landlord, boolean petFriendly, boolean wiFi, boolean kitchen,
